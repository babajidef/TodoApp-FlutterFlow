...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    _model.signUupConfirmPasswordTextController ??= TextEditingController();
    _model.signUupConfirmPasswordFocusNode ??= FocusNode();
                ...
                child: Column(
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/jides-checklist-high-resolution-logo-grayscale-transparent.png',
                        width: 120.0,
                        fit: BoxFit.cover,
                      ),
                    ),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .signUupConfirmPasswordTextController,
                                          focusNode: _model
                                              .signUupConfirmPasswordFocusNode,
                                          autofocus: false,
                                          enabled: true,
                                          textInputAction: TextInputAction.done,
                                          obscureText: !_model
                                              .signUupConfirmPasswordVisibility,
                                          decoration: InputDecoration(
                                            isDense: true,
                                            labelStyle:
                                                FlutterFlowTheme.of(context)
                                            ...
                                            suffixIcon: InkWell(
                                              ...
                                              focusNode: FocusNode(
                                                  skipTraversal: true),
                                              child: Icon(
                                                _model.signUupConfirmPasswordVisibility
                                                    ? Icons.visibility_outlined
                                                    : Icons
                                                        .visibility_off_outlined,
                                                size: 24.0,
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              if (_model.signupPasswordTextController.text !=
                                  _model.signUupConfirmPasswordTextController
                                      .text) {
